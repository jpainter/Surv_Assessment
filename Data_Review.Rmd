...
```{r select_data_elements}
    ...
    de.names_review = data_frame( 
        Include = rep( NA, length( de.names ) ) ,
        dataElement = de.names )
    
    # write file that will be used to review and select data elements 
    # de.review.csv = paste0( params$data_directory , "/" ,
    #                              params$origin_login_file , "/" ,
    #                              params$origin_login_file , "_" , 
    #                              "dataElements.csv" )
    # 
    # write_csv( de.names_review , de.review.csv )
    
    de.review.xlsx = paste0( params$data_directory , "/" ,
                                 params$origin_login_file , "/" ,
                                 params$origin_login_file , "_" , 
                                 "dataElements.xlsx" )
    
    if ( !file.exists( de.review.xlsx ) ) openxlsx::write.xlsx( de.names_review , de.review.xlsx )
