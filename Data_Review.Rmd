...
The following table is sorted by difference, so that any differences between the sum of the details and the sum of the totals would be at the top of the table.
