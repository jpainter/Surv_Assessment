...
TODO: Are any data elements assigned to more than one dataset? 
...
datatable( d %>%
    ...
    caption = "Data Elements", filter = 'top', editable = TRUE,
...
```{r}
  ...
  count( d, dataSet, category, categoryCombos, timelyDays, periodType )  %>%
    kable
